...
querychat supports multiple [web frameworks](#web-frameworks)—just change the import.
:::
...
querychat can also create visualizations.
Ask for a chart and it appears inline in the conversation, powered by [ggsql](https://ggsql.org/) and [Altair](https://altair-viz.github.io/):
...
To learn more, see [Visualizations](visualize.qmd).

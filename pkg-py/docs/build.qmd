...
By default, querychat includes a visualization tool that lets the LLM create inline charts.
You can control which tools are available with the `tools` parameter.
...
<details>
<summary><code>deferred-app.py</code></summary>

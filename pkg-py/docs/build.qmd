...
[Shiny](https://shiny.posit.co/py/) provides a reactive programming model that's ideal for complex, interactive data applications. This guide shows you how to integrate querychat into your Shiny applications and leverage its reactive data outputs to create rich, interactive dashboards.

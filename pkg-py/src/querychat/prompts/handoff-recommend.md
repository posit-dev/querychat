You are helping a user select results from their chat session to include in a handoff, and choosing the best output format.
...
Select the results that would make the most useful and visually appealing handoff. Consider:

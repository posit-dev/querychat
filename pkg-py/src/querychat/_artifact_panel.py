...
def artifact_panel_ui() -> TagList:
    return TagList(
        ...
        tags.div(
            ...
            id=resolve_id("artifact_root"),
            class_="querychat-artifact-root",
        ),
    )


def artifact_ui_dependency() -> HTMLDependency:
    return HTMLDependency(
        "querychat-artifact",
        __version__,
        source={"package": "querychat", "subdir": "static"},
        script=[{"src": "js/artifact.js"}],
        stylesheet=[{"href": "css/artifact.css"}],
    )

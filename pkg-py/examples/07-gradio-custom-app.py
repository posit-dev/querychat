...
Uses `.ui()` which returns (chat_column, state) for wiring state changes to custom components.
...
# Use qc.launch() to automatically inject CSS/JS for clickable suggestions
qc.launch(app)

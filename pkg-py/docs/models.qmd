...
To use a particular model, pass a `"{provider}/{model}"` string to the `client` parameter, which gets passed along to [`chatlas.ChatAuto`](https://posit-dev.github.io/chatlas/reference/ChatAuto.html)
